...
- **Dataset file hash (sha256):** `9fc5bb10910ebbf82c3e3a27ed2abe00d30a70739bb91e475da6839e176fb920`
- **Generated:** 2026-07-31T22:17:17.517570+00:00
...
|---|---|---|
| all_mandatory_acceptance_cases_pass | PASS | tests/pue/test_acceptance.py + tests/pue/test_golden.py must pass. |
...
| deterministic_replay_equivalent | PASS | Replaying a persisted case under identical versions reproduces an equivalent Decision. |
| no_commercial_data_in_product_identity_reasoning | PASS | Structural invariant enforced by tests/pue/test_invariants.py::test_invariant_no_commercial_fields (no price/profit/ROI field ever read by pue/claims.py, pue/evaluation.py, or pue/decisions.py). |
| versions_identified_in_manifest | PASS | See the release manifest's capability/policy/knowledge/schema version fields. |

## Product metrics

| Metric | Value | n / N (excluded) |
|---|---:|---:|
| product_form_accuracy | 1.0 | 44/44 (0) |
...
| harmful_false_match_rate | None | 0/0 (0) |
...
| avoidable_abstention_rate | None | 0/0 (0) |
| comparability_accuracy | 1.0 | 2/2 (0) |
| explanation_faithfulness | 1.0 | 118/118 (0) |

## Pipeline metrics

- **evidence_precision:** 1.0 (30/30)
- **evidence_recall:** 1.0 (30/30)
- **claim_support_correctness:** None (0/0)
...
- **listings_per_second:** 700.588
- **median_latency_ms:** 1.1474
- **p95_latency_ms:** 1.8731
- **mean_extraction_ms:** 0.2643
- **mean_retrieval_ms:** 0.3727
- **mean_evaluation_ms:** 0.2325
- **mean_decision_explanation_ms:** 0.087
- **mean_persistence_ms:** None
- **technical_failure_rate:** 0.0085 (1/118)
- **mean_reasoning_record_json_bytes:** 19931.9068

## Classifier vs PUE differential

- **both_correct:** 21
- **pue_corrects_classifier:** 83
- **classifier_correct_pue_worsens:** 1
